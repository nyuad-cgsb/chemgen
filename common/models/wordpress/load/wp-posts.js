...
WpPosts.load.postInfo = function(workflowData, plateInfo) {
  ...
  postContent = postContent + '<b>Imaging Dates: </b> ' + plateInfo.vendorPlate.creationDate;
...
WpPosts.load.createTags = function(workflowData, plateInfo) {
  var tags =  [{
    ...
    taxonomy: 'envira-tag',
    taxTerm: workflowData.screenName + '--' + plateInfo.ExperimentExperimentplate.barcode,
  }, {
