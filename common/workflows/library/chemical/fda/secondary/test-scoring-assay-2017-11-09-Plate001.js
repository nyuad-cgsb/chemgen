...
/// ////////////////////////////////
var wellDataFile = path.resolve(__dirname, 'data', '2017-11-09--FDA--Secondary_Plate001.json');
var workflowResults = require(path.resolve(__dirname, 'data', 'FDA-workflow-results.json'));

var assayDate = '2017-11-09';
...
// jsonfile.writeFileSync('FDA-results.json', results, {spaces: 2});
...
app.models.ExperimentManualscores.transform.workflows
  .score(workflowData, workflowResults)
  .then(function(results) {
